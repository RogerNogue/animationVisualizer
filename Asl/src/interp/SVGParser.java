    ...
    public static void translate(){
        try{
            ...
            for(int i = 0; i < objects.size(); ++i){
                ...
                String red, green, blue, redStroke, greenStroke, blueStroke;
                ...
                if(objects.get(i).isQuad()){
                    file.write(     "\n       <rect x=\"" + Double.toString(str.getX1())  + "\" y=\"" + Double.toString(str.getY1())
                                ...
                                +   "\n        style=\"fill:rgb(" + red + ","+ green +","+ blue +");stroke:rgb(" + redStroke + ","+ greenStroke +","+ blueStroke +");stroke-width:" + Double.toString(str.get_stroke()) + "5;fill-opacity:0.1;stroke-opacity:0.9\" />  "
                                );
